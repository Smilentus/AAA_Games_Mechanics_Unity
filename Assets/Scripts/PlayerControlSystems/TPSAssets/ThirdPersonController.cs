...
public class ThirdPersonController : MonoBehaviour
{
    ...
    [SerializeField]
    private PlayerHeadTargeting m_playerHeadTargeting;
    ...
    private void LateUpdate()
    {
        ...
        {
            _cineCameraTransposer.CameraDistance = _isStrafing
                ? Mathf.Lerp(_cineCameraTransposer.CameraDistance, 1.0f, StrafingCameraSpeed * Time.deltaTime)
                : Mathf.Lerp(_cineCameraTransposer.CameraDistance, 3.0f, StrafingCameraSpeed * Time.deltaTime);
        }
    }
    ...
    private void CameraRotation()
    {
        ...
        m_cinemachineCameraTarget.transform.rotation = Quaternion.Euler(_cinemachineTargetPitch + m_cameraAngleOverride, _cinemachineTargetYaw, 0.0f);
    }

    private void Move()
    {
        _isStrafing = Input.GetMouseButton(1);
        ...
        m_playerHeadTargeting.IsTargeting = _isStrafing;
        ...
        if (_hasAnimator)
        {
            ...
            m_animator.SetBool(_animIDStrafing, _isStrafing);
