...
public class SaveLoadSystemController
{
    private static SaveLoadSystemController _instance;
    public static SaveLoadSystemController Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = new SaveLoadSystemController();
            }
    ...
    public void SetSaveFolderPath(string persistentSavePath)
    {
        saveFolderPath = persistentSavePath;
    }
    ...
    public void ParseLoadedData(GeneralSaveData generalSaveData)
    {
        foreach (ISaveLoadConverter converter in SaveLoadConverters)
        {
            converter.ExtractGeneralSaveData(generalSaveData);
        }
    }
